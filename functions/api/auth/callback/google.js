 ...
 */
import { popupResponse, createSession, findOrCreateUser, resolveOAuthState, performOAuthBind } from '../_utils.js';
...
export async function onRequest({ request, env }) {
  ...
  if (resolved.mode === 'bind') {
    return performOAuthBind(env, request, resolved.uid, 'google', String(googleUser.id), googleUser.email || null, googleUser.picture || null);
  }
